...
class SuratController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $kodeSurat = $indeksData->kode_surat; // Misal kolom kode_surat ada di tabel Indeks
    ...
    public function balasSurat($id)
    {
        ...
        // Mengirim data ke view untuk form balas surat
    ...
    public function storeBalasSurat(Request $request, $id)
{
 ...
 // Function untuk menampilkan halaman daftar draft surat
 public function showDrafts()
 {
     $drafts = Draft::where('status', 'draft')->get(); // Ambil semua draft yang berstatus 'draft'
     return view('super_admin.draft', compact('drafts'));
 }
