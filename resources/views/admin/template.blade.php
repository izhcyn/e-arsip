                ...
                <div class="card card-table mt-4">
                    ...
                    <table class="table">
                        <thead class="thead-light">
                            ...
                            <tr>
                                <th><input type="text" id="filterJudul" class="form-control"
                                        placeholder="Filter Judul"></th>
                                <th><input type="text" id="filterIsi" class="form-control"
                                        placeholder="Filter Isi"></th>
                                <th></th>
                            </tr>
                        </thead>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            ...
                            @if ($startPage > 1)
                                <li class="page-item">
                                    <a class="page-link"
                                        href="{{ $templates->url(1) }}&limit={{ $templates->perPage() }}">1</a>
                                </li>
                                @if ($startPage > 2)
                            ...
                            @for ($i = $startPage; $i <= $endPage; $i++)
                                <li class="page-item {{ $i == $currentPage ? 'active' : '' }}">
                                    <a class="page-link"
                                        href="{{ $templates->url($i) }}&limit={{ $templates->perPage() }}">{{ $i }}</a>
                                </li>
                            @endfor
                            ...
                            @if ($endPage < $lastPage)
                                ...
                                <li class="page-item">
                                    <a class="page-link"
                                        href="{{ $templates->url($lastPage) }}&limit={{ $templates->perPage() }}">{{ $lastPage }}</a>
                                </li>
                            @endif
                    ...
                    $(document).ready(function() {
                        ...
                        $("#filterJudul, #filterIsi").on("keyup", function() {
                            ...
                            $("#templateTableBody tr").filter(function() {
                                $(this).toggle(
                                    $(this).find('td:eq(0)').text().toLowerCase().indexOf(filterJudul) > -
                                    1 &&
