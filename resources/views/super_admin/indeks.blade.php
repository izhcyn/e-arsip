                        ...
                        <div class="card-body">
                            <form action="{{ route('indeks.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input placeholder="Contoh Format : RBR/KDS" type="text" class="form-control"
                                        id="kode_surat" name="kode_surat" required>
                                </div>
                                <div class="form-group">
                                ...
                                @foreach ($indeks as $indek)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('indeks.destroy', $indek->indeks_id) }}"
                                                method="POST" id="delete-form-{{ $indek->indeks_id }}"
                                                style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button" class="btn btn-danger btn-sm"
                                                    onclick="confirmDelete({{ $indek->indeks_id }})">Hapus</button>
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
